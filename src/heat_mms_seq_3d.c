...
int main(int argc, char *argv[]) {
    ...
    int nsteps = 0;
    int diag_stride = 0;
    char output_csv[256] = "../data/mms_seq_3d.csv";
    ...
    printf("========================================================\n");
    printf("  3D Method of Manufactured Solutions (MMS) - Sequential\n");
    printf("========================================================\n");
    printf("Grid: %d x %d x %d (%zu cells) | dx: %.5f | dt: %.6f s\n", n, n, n, total_cells, dx, dt);
